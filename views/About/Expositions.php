    ...
    <div class="dropdown is-hoverable">
      ...
      <div class="dropdown-menu" id="dropdown-menu" role="menu">
        <div class="dropdown-content">
          <a href="./Expositions_list" class="dropdown-item">
            liste
          </a>
        </div>
      </div>
    ...
    <div class="card">
      ...
      <div class="card-content">
        <div class="content">
          ...
          <h2 class="card-title">Exposition interactive sur les ségas de l’Océan Indien</h2>
          <h3 class="card-subtitle">Musée Stella Matutina</h3>
    ...
    <div class="card">
      ...
      <div class="card-content">
        <div class="content">
          ...
          <h2 class="card-title">Typologie des ségas mauriciens :</h2>
          <h3 class="card-subtitle">du gro pilé au moderne.</h3>
          <p>A la fois musique et danse, le séga, se retrouve sous une forme plurielle sur cinq principales îles du
            sud-ouest de l’océan Indien.</p>
        </div>
      </div>
      <footer class="card-footer">
        <a href="#" class="card-footer-item">En savoir plus</a>

...
<div class="columns">
  <div class="column">
    <table class="table is-striped is-fullwidth">
      ...
      <tbody>
        <tr>
          <td><a href="./Article1">Alain Peters Rest' la maloya</a></td>
          <td>30.03.2019</td>
          <td>Jacques Grondin</td>
        </tr>
        <tr>
          <td>Dj Sebb, le maître réunionnais de la Gommance</td>
          <td>30.03.2019</td>
          <td>Richard Ratsimandravavalomana...</td>
        </tr>
        <tr>
          <td>Siti & The Band Le pouvoir aux femmes</td>
          <td>30.03.2019</td>
          <td>Donald Trump</td>
        </tr>
        <tr>
          <td><a href="./Article2">Le séga réunionnais inscrit à l'inventaire national du Patrimoine Culturel Immatériel de France</a></td>
          <td>30.03.2019</td>
          <td>Jacques Grondin</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex...</td>
          <td>30.03.2019</td>
          <td>Donald Trump</td>
        </tr>
        <tr>
        ...
        <tr>
          <td>Quis nostrud exercitation ullamco laboris nisi ut consequat</td>
          <td>30.03.2019</td>
          <td>Jacques Grondin</td>
        </tr>
        <tr>

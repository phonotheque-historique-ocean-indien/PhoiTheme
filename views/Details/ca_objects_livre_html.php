...
<div class="columns">
  ...
  <div class="column">
    <div class="card">
	  <header class="card-header">
	    <p class="card-header-title">
	      <?php _p("Informations sur l'item livre"); ?>
	    </p>
          <a href="<?= __CA_URL_ROOT__ ?>/index.php/Contribuer/Do/EditForm/table/ca_objects/type/<?= $type ?>/id/<?= $vn_id ?>" class="card-header-icon" aria-label="edit" style="/* display: none; */">
            <span class="icon">
                <i class="mdi mdi-pencil is-large"></i>
	  ...
	  <div class="card-content">
	    <div class="content content-infos-phonogramme">
            {{{
            <p>ISBN : ^ca_objects.isbn</p>
            <p>Auteur : <unit relativeTo="ca_entities">^ca_entities.preferred_labels.displayname</unit></p>
            <p>Titre : ^ca_objects.preferred_labels</p>
            <p>Genre : ^ca_objects.genre</p>
            <p>Pays : ^ca_objects.pays</p>
            <p>Editeur : <unit relativeTo="ca_entities">^ca_entities.preferred_labels.displayname</unit></p>
            <p>Item : ^ca_objects.idno</p>
            <p>Date : ^ca_objects.date</p>
            <p>Collection : ^ca_objects.collection</p>
            <p>Lieu : ^ca_objects.lieux</p>
            <br/>
            <p>Notes : ^ca_objects.notes</p>
            <p>Remarques : ^ca_objects.remarques</p>
            }}}
	    </div>
	  </div>
	</div>
	...
	<div class="card medias">
	  ...
	  <div class="card-content">
	    <div class="content" id="imageviewer">
			...
			if(!sizeof($representations)) {
				$isbn = $t_object->get("ca_objects.isbn");
				$isbn = preg_replace("/[^0-9]/", "", $isbn);
				print "<img src='http://covers.openlibrary.org/b/isbn/".$isbn."-M.jpg'/>";
			}
			?>
	    </div>
	  </div>

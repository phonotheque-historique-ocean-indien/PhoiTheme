...
"<li>
	<div class='card-content-item'>
		<p onclick='loadTrack(\"^ca_objects.preferred_labels.name\",\"^ca_object_representations.media.mp3.url \");'><span class=\"tag is-light\">^ca_objects.face</span>  ^ca_objects.preferred_labels.name</p>
		<div class='icon-group'>
			<a href='#' class='card-content-icon' aria-label='delete'>
				<span class='icon'>
					<i class='mdi mdi-close is-large'></i>
				...
				<span class='icon'>
					<i class='mdi mdi-information is-large'></i>
                        ...
                        foreach($children as $key=>$child_id) {
                            ...
                            print $vt_object->getWithTemplate($template);
                        }
                        ?>
	...
	<div class="card medias">
	  <header class="card-header">
	    <p class="card-header-title">
	      <?php print $t_object->getRepresentationCount(); ?> médias attachés
	    </p>
	  </header>
	  <div class="card-content">
	    <div class="content">
